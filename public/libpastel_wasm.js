...
var ASM_CONSTS = {
  1284692: () => { return Module.getRandomValue(); },  
 ...
 1285504: () => { if (!FS.analyzePath('/wallet_data').exists) { FS.mkdir('/wallet_data'); FS.mount(IDBFS, {}, '/wallet_data'); console.log('/wallet_data directory created and IDBFS mounted.'); } else { console.log('/wallet_data directory already exists, no need to mount IDBFS.'); } FS.syncfs(true, function(err) { if (err) { console.error('Error syncing file system:', err); } else { console.log('File system synced successfully.'); } }); },  
 1285926: () => { FS.syncfs(function(err) { if (err) { console.error('Error syncing file system:', err); } else { console.log('File system synced successfully.'); } }); }
};
...
var dynCall_iiijiji = Module['dynCall_iiijiji'] = (a0, a1, a2, a3, a4, a5, a6, a7, a8) => (dynCall_iiijiji = Module['dynCall_iiijiji'] = wasmExports['dynCall_iiijiji'])(a0, a1, a2, a3, a4, a5, a6, a7, a8);

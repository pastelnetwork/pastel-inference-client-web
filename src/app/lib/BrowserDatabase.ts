...
import pastelGlobals from '@/app/lib/globals';
      ...
      const storeDefinitions = [
        {
          ...
          autoIncrement: true,
          indexes: [
            { name: 'txid_vout', keyPath: 'txid_vout', options: { unique: false } },
            {
          ...
          indexes: [
            {
              ...
              keyPath: 'sha3_256_hash_of_credit_pack_purchase_request_response_fields',
              options: { unique: true },
            },
          ],
        },
          ...
          indexes: [
            {
              ...
              keyPath: 'sha3_256_hash_of_credit_pack_purchase_request_confirmation_fields',
              options: { unique: true },
            },
          ],
        },
          ...
          indexes: [
            {
              ...
              keyPath: 'sha3_256_hash_of_credit_pack_purchase_request_status_fields',
              options: { unique: true },
            },
          ],
        },
  ...
  type ModelMethods<T> = {
    ...
    findAll: () => Promise<T[]>;
    findOne: (options: { where: { [key: string]: any } }) => Promise<T | undefined>;
  };
  ...
  const models = {
    ...
    CreditPackPurchaseRequestRejection: createModelMethods<
      CreditPackPurchaseRequestRejection
    >('CreditPackPurchaseRequestRejection'),
    CreditPackPurchaseRequestPreliminaryPriceQuote: createModelMethods<
      CreditPackPurchaseRequestPreliminaryPriceQuote
    >('CreditPackPurchaseRequestPreliminaryPriceQuote'),
    CreditPackPurchaseRequestPreliminaryPriceQuoteResponse: createModelMethods<
      CreditPackPurchaseRequestPreliminaryPriceQuoteResponse
    >('CreditPackPurchaseRequestPreliminaryPriceQuoteResponse'),
    CreditPackPurchaseRequestResponseTermination: createModelMethods<
      CreditPackPurchaseRequestResponseTermination
    >('CreditPackPurchaseRequestResponseTermination'),
    CreditPackPurchaseRequestResponse: createModelMethods<
      CreditPackPurchaseRequestResponse
    >('CreditPackPurchaseRequestResponse'),
    CreditPackPurchaseRequestConfirmation: createModelMethods<
      CreditPackPurchaseRequestConfirmation
    >('CreditPackPurchaseRequestConfirmation'),
    CreditPackPurchaseRequestConfirmationResponse: createModelMethods<
      CreditPackPurchaseRequestConfirmationResponse
    >('CreditPackPurchaseRequestConfirmationResponse'),
    CreditPackRequestStatusCheck: createModelMethods<CreditPackRequestStatusCheck>(
      'CreditPackRequestStatusCheck'
    ),
    CreditPackPurchaseRequestStatus: createModelMethods<
      CreditPackPurchaseRequestStatus
    >('CreditPackPurchaseRequestStatus'),
    CreditPackStorageRetryRequest: createModelMethods<
      CreditPackStorageRetryRequest
    >('CreditPackStorageRetryRequest'),
    CreditPackStorageRetryRequestResponse: createModelMethods<
      CreditPackStorageRetryRequestResponse
    >('CreditPackStorageRetryRequestResponse'),
  ...
  export { models, initializeDatabase };

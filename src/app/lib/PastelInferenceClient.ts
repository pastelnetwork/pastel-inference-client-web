...
class PastelInferenceClient {
  ...
  async creditPackTicketInitialPurchaseRequest(
    ...
    try {
      ...
      callback(
        JSON.stringify({
          message: `Now requesting a new Pastel credit pack ticket with payload:\n${utils.formattedPayload(
            validatedCreditPackRequest
          )}`,
        })
      );
      ...
      if ("rejection_reason_string" in result) {
        callback(
          JSON.stringify({
            message: `Credit pack purchase request rejected: ${result.rejection_reason_string}`,
          })
        );
        console.error(
        ...
        callback(
          JSON.stringify({
            message: `Now receiving response to credit pack purchase request with payload:\n${utils.formattedPayload(
              result
            )}`,
          })
        );
      ...
      callback(
        JSON.stringify({
          message: `Error initiating credit pack ticket purchase: ${utils.safeStringify(
            error
          )}`,
        })
      );
  ...
  async confirmPreliminaryPriceQuote(
    ...
    if (
      ...
      callback(
        JSON.stringify({
          message: `Preliminary price quote is within the acceptable range: ${numberFormat.format(
            quotedPricePerCredit
      ...
      callback(
        JSON.stringify({
          message: `Preliminary price quote exceeds the maximum acceptable price or the price difference from the estimated fair price is too high! Quoted price: ${numberFormat.format(
            quotedPricePerCredit
          )} PSL per credit, ${numberFormat.format(
            quotedTotalPrice
  ...
  > {
    try {
      if ("rejection_reason_string" in preliminaryPriceQuote) {
        callback(
          JSON.stringify({
            message: `Credit pack purchase request rejected: ${preliminaryPriceQuote.rejection_reason_string}`,
          })
        );
        console.error(
      ...
      if (agreeWithPriceQuote) {
        callback(
          JSON.stringify({
            message: `Agree with price quote: ${agreeWithPriceQuote}; responding to preliminary price quote to Supernode at ${supernodeURL}...`,
          })
        );
      }
      console.info(
      ...
      if ("termination_reason_string" in result) {
        callback(
          JSON.stringify({
            message: `Credit pack purchase request response terminated: ${result.termination_reason_string}`,
          })
        );
        console.error(
      ...
      callback(
        JSON.stringify({
          message: `Error responding to preliminary price quote: ${utils.safeStringify(
            error
          )}`,
        })
      );
  ...
  async confirmCreditPurchaseRequest(
    ...
    try {
      ...
      callback(
        JSON.stringify({
          message: `Now confirming credit pack purchase request with payload:\n${utils.formattedPayload(
            payload
          )}`,
        })
      );
      ...
      callback(
        JSON.stringify({
          message: `Now receiving response to credit pack purchase confirmation with payload:\n${utils.formattedPayload(
            result
          )}`,
        })
      );
      ...
      callback(
        JSON.stringify({
          message: `Error confirming credit pack purchase request: ${utils.safeStringify(
            error
          )}`,
        })
      );
  ...
  async checkStatusOfCreditPurchaseRequest(
    ...
    try {
      ...
      callback(
        JSON.stringify({
          message: `Now checking status of credit pack purchase request with payload:\n${utils.formattedPayload(
      ...
      callback(
        JSON.stringify({
          message: `Now receiving credit pack purchase request response from Supernode with payload:\n${utils.formattedPayload(
            responseData
          )}`,
        })
      );
      ...
      callback(
        JSON.stringify({
          message: `Error checking status of credit purchase request: ${utils.safeStringify(
            error
          )}`,
        })
      );
  ...
  async creditPackStorageRetryRequest(
    ...
    try {
      ...
      callback(
        JSON.stringify({
          message: `Now sending credit pack storage retry request with payload:\n${utils.formattedPayload(
            payload
          )}`,
        })
      );
      ...
      callback(
        JSON.stringify({
          message: `Now receiving response to credit pack storage retry request with payload:\n${utils.formattedPayload(
            result
          )}`,
        })
      );
      ...
      callback(
        JSON.stringify({
          message: `Error sending credit pack storage retry request: ${utils.safeStringify(
            error
          )}`,
        })
      );
  ...
  async makeInferenceAPIUsageRequest(
    ...
    try {
      ...
      callback(
        JSON.stringify({
          message: `Now making inference usage request with payload:\n${utils.formattedPayload(
            validatedRequest
          )}`,
        })
      );
      ...
      callback(
        JSON.stringify({
          message: `Now received response to inference usage request with payload:\n${utils.formattedPayload(
            result
          )}`,
        })
      );
      ...
      callback(
        JSON.stringify({
          message: `Error making inference API usage request: ${utils.safeStringify(
            error
          )}`,
        })
      );
  ...
  async sendInferenceConfirmation(
    ...
    try {
      ...
      callback(
        JSON.stringify({
          message: `Now sending inference confirmation with payload:\n${utils.formattedPayload(
            payload
          )}`,
        })
      );
      ...
      callback(
        JSON.stringify({
          message: `Now receiving response to inference confirmation with payload:\n${utils.formattedPayload(
            result
          )}`,
        })
      );
  ...
  async checkStatusOfInferenceRequestResults(
    ...
    try {
      ...
      callback(
        JSON.stringify({
          message: `Checking status of inference request results for ID ${inferenceResponseID}`,
        })
      );
      const response = await fetch(
      ...
      callback(
        JSON.stringify({
          message: `Now receiving status of inference request results for ID ${inferenceResponseID} with payload:\n${utils.formattedPayload(
            result
          )}`,
        })
      );
      ...
      callback(
        JSON.stringify({
          message: `Error checking status of inference request results from Supernode URL: ${supernodeURL}: ${utils.safeStringify(
            error
          )}`,
        })
      );
  ...
  async retrieveInferenceOutputResults(
    ...
    try {
      ...
      callback(
        JSON.stringify({
          message: `Now attempting to retrieve inference output results for response ID ${inferenceResponseID} with payload:\n${utils.formattedPayload(
            params
          )}`,
        })
      );
      ...
      callback(
        JSON.stringify({
          message: `Now receiving inference output results with payload:\n${utils.formattedPayload(
            result
          )}`,
        })
      );
      ...
      callback(
        JSON.stringify({
          message: `Error retrieving inference output results: ${utils.safeStringify(
            error
          )}`,
        })
      );
